...
public final class WoolEnUKLanguageProvider extends FabricLanguageProvider {

    private static final String MOD_ID = Wool.MOD_ID;

    public WoolEnUKLanguageProvider(FabricDataOutput dataOutput, CompletableFuture<RegistryWrapper.WrapperLookup> registryLookup) {
