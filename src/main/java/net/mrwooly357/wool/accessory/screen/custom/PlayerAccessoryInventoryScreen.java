package net.mrwooly357.wool.accessory.screen.custom;
...
public class PlayerAccessoryInventoryScreen extends HandledScreen<PlayerAccessoryInventoryScreenHandler> {
    ...
    private List<Identifier> unitOrder;

    private static final Identifier GUI_TEXTURE = Identifier.of(Wool.MOD_ID, "textures/gui/player_accessory_inventory.png");
    private static final Identifier FULL_TEXTURE = Identifier.of(Wool.MOD_ID, "textures/gui/sprites/accessory/slot/full.png");
    private static final Identifier REGULAR_TEXTURE = Identifier.of(Wool.MOD_ID, "textures/gui/sprites/accessory/slot/regular.png");
    private static final Identifier BOTTOM_CONNECTED_TEXTURE = Identifier.of(Wool.MOD_ID, "textures/gui/sprites/accessory/slot/bottom_connected.png");
    private static final Identifier TOP_CONNECTED_TEXTURE = Identifier.of(Wool.MOD_ID, "textures/gui/sprites/accessory/slot/top_connected.png");
    private static final Identifier RIGHT_BOTTOM_CORNER_TEXTURE = Identifier.of(Wool.MOD_ID, "textures/gui/sprites/accessory/slot/right_bottom_corner.png");
    private static final Identifier LEFT_BOTTOM_CORNER_TEXTURE = Identifier.of(Wool.MOD_ID, "textures/gui/sprites/accessory/slot/left_bottom_corner.png");
    private static final Identifier RIGHT_TOP_CORNER_TEXTURE = Identifier.of(Wool.MOD_ID, "textures/gui/sprites/accessory/slot/right_top_corner.png");
    private static final Identifier LEFT_TOP_CORNER_TEXTURE = Identifier.of(Wool.MOD_ID, "textures/gui/sprites/accessory/slot/left_top_corner.png");
    private static final Identifier BOTTOM_SIDE_TEXTURE = Identifier.of(Wool.MOD_ID, "textures/gui/sprites/accessory/slot/bottom_side.png");
    private static final Identifier RIGHT_SIDE_TEXTURE = Identifier.of(Wool.MOD_ID, "textures/gui/sprites/accessory/slot/right_side.png");
    private static final Identifier LEFT_SIDE_TEXTURE = Identifier.of(Wool.MOD_ID, "textures/gui/sprites/accessory/slot/left_side.png");
    private static final Identifier RIGHT_AND_LEFT_SIDES_TEXTURE = Identifier.of(Wool.MOD_ID, "textures/gui/sprites/accessory/slot/right_and_left_sides.png");
    private static final Identifier TOP_SIDE_TEXTURE = Identifier.of(Wool.MOD_ID, "textures/gui/sprites/accessory/slot/top_side.png");
    private static final Identifier CONNECTING_CORNER_TEXTURE_0 = Identifier.of(Wool.MOD_ID, "textures/gui/sprites/accessory/slot/connecting_corner_0.png");
    private static final Identifier CONNECTING_CORNER_TEXTURE_1 = Identifier.of(Wool.MOD_ID, "textures/gui/sprites/accessory/slot/connecting_corner_1.png");
    ...
    public PlayerAccessoryInventoryScreen(PlayerAccessoryInventoryScreenHandler handler, PlayerInventory inventory, Text title) {
        ...
        if (inventory.player instanceof AccessoryInventoryHolder holder) {
            ...
            unitOrder = AccessoryInventoryManager.UNIT_ORDER.get(holder.getRegistry());
        }
    }
    ...
    protected void drawBackground(DrawContext context, float delta, int mouseX, int mouseY) {
        ...
        for (Identifier id : unitOrder) {
            AccessoryInventoryUnit unit = accessoryInventory.get(id);
